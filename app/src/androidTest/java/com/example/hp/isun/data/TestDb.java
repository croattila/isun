 ...
 */
package com.example.hp.isun.data;
...
public class TestDb extends AndroidTestCase {
   ...
   ;
    ...
    public void testWeatherTable() {
        ...
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed to validate",weatherCursor,
                weathervalues);

        assertFalse("Error: Move than one record returned from weather query", weatherCursor.moveToNext());
